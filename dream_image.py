...
def DDFile(file_name, inputLayers=['wavy']):
    ...
    for layer in inputLayers:
        ...
        result.save(f'out/{base_name}_{layer}.jpg')
        # result.show()
